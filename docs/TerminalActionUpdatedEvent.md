...
**r#type** | Option<**String**> | The type of event this represents, `\"terminal.action.updated\"`. | [optional]
...
**data** | Option<[**models::TerminalActionUpdatedEventData**](TerminalActionUpdatedEventData.md)> |  | [optional]
