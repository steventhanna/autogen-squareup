...
**r#type** | Option<**String**> | The type of event. For this object, the value is `customer.deleted`. | [optional]
...
**data** | Option<[**models::CustomerDeletedEventData**](CustomerDeletedEventData.md)> |  | [optional]
