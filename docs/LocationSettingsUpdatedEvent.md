...
**r#type** | Option<**String**> | The type of event this represents, `\"online_checkout.location_settings.updated\"`. | [optional]
...
**data** | Option<[**models::LocationSettingsUpdatedEventData**](LocationSettingsUpdatedEventData.md)> |  | [optional]
