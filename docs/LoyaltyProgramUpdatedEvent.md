...
**r#type** | Option<**String**> | The type of event. For this event, the value is `loyalty.program.updated`. | [optional]
...
**data** | Option<[**models::LoyaltyProgramUpdatedEventData**](LoyaltyProgramUpdatedEventData.md)> |  | [optional]
