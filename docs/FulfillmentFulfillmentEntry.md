...
------------ | ------------- | ------------- | -------------
**uid** | Option<**String**> | A unique ID that identifies the fulfillment entry only within this order. | [optional]
**line_item_uid** | **String** | The `uid` from the order line item. | 
