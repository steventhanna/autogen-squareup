...
**r#type** | Option<**String**> | The type of event. For this object, the value is `customer.created`. | [optional]
...
**data** | Option<[**models::CustomerCreatedEventData**](CustomerCreatedEventData.md)> |  | [optional]
