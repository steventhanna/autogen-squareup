...
**r#type** | Option<**String**> | The type of event. For this event, the value is `gift_card.activity.created`. | [optional]
...
**data** | Option<[**models::GiftCardActivityCreatedEventData**](GiftCardActivityCreatedEventData.md)> |  | [optional]
