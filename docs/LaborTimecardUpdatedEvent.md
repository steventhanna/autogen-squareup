...
**r#type** | Option<**String**> | The type of event. For this event, the value is `labor.timecard.updated`. | [optional]
...
**data** | Option<[**models::LaborTimecardUpdatedEventData**](LaborTimecardUpdatedEventData.md)> |  | [optional]
