...
**order** | [**models::CreateOrderRequest**](CreateOrderRequest.md) |  | 
**ask_for_shipping_address** | Option<**bool**> | If `true`, Square Checkout collects shipping information on your behalf and stores  that information with the transaction information in the Square Seller Dashboard.  Default: `false`. | [optional]
