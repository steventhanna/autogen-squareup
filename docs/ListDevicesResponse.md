...
------------ | ------------- | ------------- | -------------
**errors** | Option<[**Vec<models::Error>**](Error.md)> | Information about errors that occurred during the request. | [optional]
**devices** | Option<[**Vec<models::Device>**](Device.md)> | The requested list of `Device` objects. | [optional]
