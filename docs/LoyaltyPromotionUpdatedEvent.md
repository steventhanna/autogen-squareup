...
**r#type** | Option<**String**> | The type of event. For this event, the value is `loyalty.promotion.updated`. | [optional]
...
**data** | Option<[**models::LoyaltyPromotionUpdatedEventData**](LoyaltyPromotionUpdatedEventData.md)> |  | [optional]
