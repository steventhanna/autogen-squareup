...
**r#type** | Option<**String**> | The type of event this represents, `\"terminal.refund.updated\"`. | [optional]
...
**data** | Option<[**models::TerminalRefundUpdatedEventData**](TerminalRefundUpdatedEventData.md)> |  | [optional]
