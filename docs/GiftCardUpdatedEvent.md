...
**r#type** | Option<**String**> | The type of this event. For this event, the value is `gift_card.updated`. | [optional]
...
**data** | Option<[**models::GiftCardUpdatedEventData**](GiftCardUpdatedEventData.md)> |  | [optional]
