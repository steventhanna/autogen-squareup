...
**r#type** | Option<**String**> | The type of event this represents, `\"terminal.checkout.created\"`. | [optional]
...
**data** | Option<[**models::TerminalCheckoutCreatedEventData**](TerminalCheckoutCreatedEventData.md)> |  | [optional]
