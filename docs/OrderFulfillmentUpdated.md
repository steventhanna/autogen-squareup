...
**updated_at** | Option<**String**> | The timestamp for when the order was last updated, in RFC 3339 format. | [optional][readonly]
**fulfillment_update** | Option<[**Vec<models::OrderFulfillmentUpdatedUpdate>**](OrderFulfillmentUpdatedUpdate.md)> | The fulfillments that were updated with this version change. | [optional]
