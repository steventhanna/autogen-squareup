...
**r#type** | Option<**String**> | The type of event. For this event, the value is `gift_card.created`. | [optional]
...
**data** | Option<[**models::GiftCardCreatedEventData**](GiftCardCreatedEventData.md)> |  | [optional]
