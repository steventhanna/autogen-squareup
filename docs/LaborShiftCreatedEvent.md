...
**r#type** | Option<**String**> | The type of event. For this event, the value is `labor.shift.created`. | [optional]
...
**data** | Option<[**models::LaborShiftCreatedEventData**](LaborShiftCreatedEventData.md)> |  | [optional]
