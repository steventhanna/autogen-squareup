...
**r#type** | Option<**String**> | The type of event. For this event, the value is `gift_card.customer_linked`. | [optional]
...
**data** | Option<[**models::GiftCardCustomerLinkedEventData**](GiftCardCustomerLinkedEventData.md)> |  | [optional]
