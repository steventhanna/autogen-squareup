...
**r#type** | Option<**String**> | The type of event this represents, `\"terminal.checkout.updated\"`. | [optional]
...
**data** | Option<[**models::TerminalCheckoutUpdatedEventData**](TerminalCheckoutUpdatedEventData.md)> |  | [optional]
