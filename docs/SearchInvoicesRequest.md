...
------------ | ------------- | ------------- | -------------
**query** | [**models::InvoiceQuery**](InvoiceQuery.md) |  | 
**limit** | Option<**i32**> | The maximum number of invoices to return (200 is the maximum `limit`).  If not provided, the server uses a default limit of 100 invoices. | [optional]
