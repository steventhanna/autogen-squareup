...
**r#type** | Option<**String**> | The type of event. For this event, the value is `loyalty.event.created`. | [optional]
...
**data** | Option<[**models::LoyaltyEventCreatedEventData**](LoyaltyEventCreatedEventData.md)> |  | [optional]
