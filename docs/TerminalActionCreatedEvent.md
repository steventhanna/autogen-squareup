...
**r#type** | Option<**String**> | The type of event this represents, `\"terminal.action.created\"`. | [optional]
...
**data** | Option<[**models::TerminalActionCreatedEventData**](TerminalActionCreatedEventData.md)> |  | [optional]
