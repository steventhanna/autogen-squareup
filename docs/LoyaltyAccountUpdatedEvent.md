...
**r#type** | Option<**String**> | The type of event. For this event, the value is `loyalty.account.updated`. | [optional]
...
**data** | Option<[**models::LoyaltyAccountUpdatedEventData**](LoyaltyAccountUpdatedEventData.md)> |  | [optional]
