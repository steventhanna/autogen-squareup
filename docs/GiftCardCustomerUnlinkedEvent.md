...
**r#type** | Option<**String**> | The type of event. For this event, the value is `gift_card.customer_unlinked`. | [optional]
...
**data** | Option<[**models::GiftCardCustomerUnlinkedEventData**](GiftCardCustomerUnlinkedEventData.md)> |  | [optional]
