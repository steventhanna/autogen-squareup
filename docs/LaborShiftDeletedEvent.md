...
**r#type** | Option<**String**> | The type of event. For this event, the value is `labor.shift.deleted`. | [optional]
...
**data** | Option<[**models::LaborShiftDeletedEventData**](LaborShiftDeletedEventData.md)> |  | [optional]
