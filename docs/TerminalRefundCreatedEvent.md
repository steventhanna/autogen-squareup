...
**r#type** | Option<**String**> | The type of event this represents, `\"terminal.refund.created\"`. | [optional]
...
**data** | Option<[**models::TerminalRefundCreatedEventData**](TerminalRefundCreatedEventData.md)> |  | [optional]
