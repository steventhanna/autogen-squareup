...
------------ | ------------- | ------------- | -------------
**object_ids** | **Vec<String>** | The IDs of the CatalogObjects to be retrieved. | 
...
**catalog_version** | Option<**i64**> | The specific version of the catalog objects to be included in the response.  This allows you to retrieve historical versions of objects. The specified version value is matched against the [CatalogObject](entity:CatalogObject)s' `version` attribute. If not included, results will be from the current version of the catalog. | [optional]
**include_deleted_objects** | Option<**bool**> | Indicates whether to include (`true`) or not (`false`) in the response deleted objects, namely, those with the `is_deleted` attribute set to `true`. | [optional]
