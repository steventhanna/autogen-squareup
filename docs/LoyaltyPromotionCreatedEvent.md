...
**r#type** | Option<**String**> | The type of event. For this event, the value is `loyalty.promotion.created`. | [optional]
...
**data** | Option<[**models::LoyaltyPromotionCreatedEventData**](LoyaltyPromotionCreatedEventData.md)> |  | [optional]
