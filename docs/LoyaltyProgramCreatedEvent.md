...
**r#type** | Option<**String**> | The type of event. For this event, the value is `loyalty.program.created`. | [optional]
...
**data** | Option<[**models::LoyaltyProgramCreatedEventData**](LoyaltyProgramCreatedEventData.md)> |  | [optional]
