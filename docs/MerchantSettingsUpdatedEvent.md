...
**r#type** | Option<**String**> | The type of event this represents, `\"online_checkout.merchant_settings.updated\"`. | [optional]
...
**data** | Option<[**models::MerchantSettingsUpdatedEventData**](MerchantSettingsUpdatedEventData.md)> |  | [optional]
