...
**r#type** | Option<**String**> | The type of event. For this event, the value is `labor.shift.updated`. | [optional]
...
**data** | Option<[**models::LaborShiftUpdatedEventData**](LaborShiftUpdatedEventData.md)> |  | [optional]
