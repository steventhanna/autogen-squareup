...
**r#type** | Option<**String**> | The type of event. For this event, the value is `gift_card.activity.updated`. | [optional]
...
**data** | Option<[**models::GiftCardActivityUpdatedEventData**](GiftCardActivityUpdatedEventData.md)> |  | [optional]
