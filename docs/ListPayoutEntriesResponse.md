...
------------ | ------------- | ------------- | -------------
**payout_entries** | Option<[**Vec<models::PayoutEntry>**](PayoutEntry.md)> | The requested list of payout entries, ordered with the given or default sort order. | [optional]
