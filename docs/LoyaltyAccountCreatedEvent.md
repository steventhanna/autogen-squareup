...
**r#type** | Option<**String**> | The type of event. For this event, the value is `loyalty.account.created`. | [optional]
...
**data** | Option<[**models::LoyaltyAccountCreatedEventData**](LoyaltyAccountCreatedEventData.md)> |  | [optional]
