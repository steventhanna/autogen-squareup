...
------------ | ------------- | ------------- | -------------
**custom_attribute_definitions** | [**Vec<models::CustomAttributeDefinition>**](CustomAttributeDefinition.md) | The retrieved custom attribute definitions. If no custom attribute definitions are found, Square returns an empty object (`{}`). | 
