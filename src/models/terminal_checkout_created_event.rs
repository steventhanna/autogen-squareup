...
/// TerminalCheckoutCreatedEvent : Published when a [TerminalCheckout](entity:TerminalCheckout) is created.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct TerminalCheckoutCreatedEvent {
    ...
    pub data: Option<Box<models::TerminalCheckoutCreatedEventData>>,
}

impl TerminalCheckoutCreatedEvent {
    /// Published when a [TerminalCheckout](entity:TerminalCheckout) is created.
    pub fn new() -> TerminalCheckoutCreatedEvent {
