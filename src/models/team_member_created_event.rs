...
/// TeamMemberCreatedEvent : Published when a Team Member is created.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct TeamMemberCreatedEvent {
    ...
    pub data: Option<Box<models::TeamMemberCreatedEventData>>,
}

impl TeamMemberCreatedEvent {
    /// Published when a Team Member is created.
    pub fn new() -> TeamMemberCreatedEvent {
