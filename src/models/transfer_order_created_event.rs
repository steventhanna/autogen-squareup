...
/// TransferOrderCreatedEvent : Published when a transfer_order is created.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct TransferOrderCreatedEvent {
    ...
    pub data: Option<Box<models::TransferOrderCreatedEventData>>,
}

impl TransferOrderCreatedEvent {
    /// Published when a transfer_order is created.
    pub fn new() -> TransferOrderCreatedEvent {
