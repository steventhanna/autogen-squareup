...
/// LaborShiftUpdatedEvent : Published when a [Shift](entity:Shift) is updated.  Deprecated at Square API version 2025-05-21. Replaced by `labor.timecard.updated`.
...
pub struct LaborShiftUpdatedEvent {
    ...
    pub data: Option<Box<models::LaborShiftUpdatedEventData>>,
}

impl LaborShiftUpdatedEvent {
    /// Published when a [Shift](entity:Shift) is updated.  Deprecated at Square API version 2025-05-21. Replaced by `labor.timecard.updated`.
