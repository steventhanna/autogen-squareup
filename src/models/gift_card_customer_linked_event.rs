...
/// GiftCardCustomerLinkedEvent : Published when a [customer](entity:Customer) is linked to a [gift card](entity:GiftCard).
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct GiftCardCustomerLinkedEvent {
    ...
    pub data: Option<Box<models::GiftCardCustomerLinkedEventData>>,
}

impl GiftCardCustomerLinkedEvent {
    /// Published when a [customer](entity:Customer) is linked to a [gift card](entity:GiftCard).
    pub fn new() -> GiftCardCustomerLinkedEvent {
