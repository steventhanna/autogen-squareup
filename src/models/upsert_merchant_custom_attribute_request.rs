...
/// UpsertMerchantCustomAttributeRequest : Represents an [UpsertMerchantCustomAttribute](api-endpoint:MerchantCustomAttributes-UpsertMerchantCustomAttribute) request.
...
impl UpsertMerchantCustomAttributeRequest {
    ...
    pub fn new(custom_attribute: models::CustomAttribute) -> UpsertMerchantCustomAttributeRequest {
