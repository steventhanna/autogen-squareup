...
/// InvoiceDeletedEvent : Published when a draft [Invoice](entity:Invoice) is deleted.
...
pub struct InvoiceDeletedEvent {
    ...
    pub data: Option<Box<models::InvoiceDeletedEventData>>,
}

impl InvoiceDeletedEvent {
    /// Published when a draft [Invoice](entity:Invoice) is deleted.
    pub fn new() -> InvoiceDeletedEvent {
        InvoiceDeletedEvent {
            merchant_id: None,
            r#type: None,
            event_id: None,
