...
/// TeamMemberUpdatedEvent : Published when a Team Member is updated.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct TeamMemberUpdatedEvent {
    ...
    pub data: Option<Box<models::TeamMemberUpdatedEventData>>,
}

impl TeamMemberUpdatedEvent {
    /// Published when a Team Member is updated.
    pub fn new() -> TeamMemberUpdatedEvent {
