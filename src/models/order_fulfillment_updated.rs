...
pub struct OrderFulfillmentUpdated {
    ...
    #[serde(rename = "fulfillment_update", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub fulfillment_update: Option<Option<Vec<models::OrderFulfillmentUpdatedUpdate>>>,
}

impl OrderFulfillmentUpdated {
    pub fn new() -> OrderFulfillmentUpdated {
