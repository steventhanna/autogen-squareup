...
/// OrderCustomAttributeVisibleUpdatedEvent : Published when an order [custom attribute](entity:CustomAttribute) that is visible to the subscribing app is updated.
