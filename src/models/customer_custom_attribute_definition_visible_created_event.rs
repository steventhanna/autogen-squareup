...
impl CustomerCustomAttributeDefinitionVisibleCreatedEvent {
    ...
    pub fn new() -> CustomerCustomAttributeDefinitionVisibleCreatedEvent {
        CustomerCustomAttributeDefinitionVisibleCreatedEvent {
            merchant_id: None,
            r#type: None,
            event_id: None,
