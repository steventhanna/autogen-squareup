...
/// RefundCreatedEvent : Published when a [Refund](entity:PaymentRefund) is created.
...
pub struct RefundCreatedEvent {
    ...
    pub data: Option<Box<models::RefundCreatedEventData>>,
}

impl RefundCreatedEvent {
    /// Published when a [Refund](entity:PaymentRefund) is created.
    pub fn new() -> RefundCreatedEvent {
        RefundCreatedEvent {
            merchant_id: None,
            r#type: None,
            event_id: None,
