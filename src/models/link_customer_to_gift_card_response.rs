...
/// LinkCustomerToGiftCardResponse : A response that contains the linked `GiftCard` object. If the request resulted in errors,  the response contains a set of `Error` objects.
...
impl LinkCustomerToGiftCardResponse {
    ...
    pub fn new() -> LinkCustomerToGiftCardResponse {
