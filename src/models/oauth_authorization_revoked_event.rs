...
/// OauthAuthorizationRevokedEvent : Published when a merchant/application revokes all access tokens and refresh tokens granted to an application.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct OauthAuthorizationRevokedEvent {
    ...
    pub data: Option<Box<models::OauthAuthorizationRevokedEventData>>,
}

impl OauthAuthorizationRevokedEvent {
    /// Published when a merchant/application revokes all access tokens and refresh tokens granted to an application.
    pub fn new() -> OauthAuthorizationRevokedEvent {
