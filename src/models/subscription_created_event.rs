...
/// SubscriptionCreatedEvent : Published when a [Subscription](entity:Subscription) is created.
...
pub struct SubscriptionCreatedEvent {
    ...
    pub data: Option<Box<models::SubscriptionCreatedEventData>>,
}

impl SubscriptionCreatedEvent {
    /// Published when a [Subscription](entity:Subscription) is created.
    pub fn new() -> SubscriptionCreatedEvent {
