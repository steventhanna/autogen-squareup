...
/// OrderCustomAttributeDefinitionOwnedCreatedEvent : Published when an order [custom attribute definition](entity:CustomAttributeDefinition) that is owned by the subscribing app is created.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct OrderCustomAttributeDefinitionOwnedCreatedEvent {
...
impl OrderCustomAttributeDefinitionOwnedCreatedEvent {
    ...
    pub fn new() -> OrderCustomAttributeDefinitionOwnedCreatedEvent {
