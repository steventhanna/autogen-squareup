...
/// TerminalRefundCreatedEvent : Published when a Terminal API refund is created.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct TerminalRefundCreatedEvent {
    ...
    pub data: Option<Box<models::TerminalRefundCreatedEventData>>,
}

impl TerminalRefundCreatedEvent {
    /// Published when a Terminal API refund is created.
    pub fn new() -> TerminalRefundCreatedEvent {
