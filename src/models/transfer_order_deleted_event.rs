...
/// TransferOrderDeletedEvent : Published when a transfer_order is deleted.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct TransferOrderDeletedEvent {
    ...
    pub data: Option<Box<models::TransferOrderDeletedEventData>>,
}

impl TransferOrderDeletedEvent {
    /// Published when a transfer_order is deleted.
    pub fn new() -> TransferOrderDeletedEvent {
