...
/// UpsertLocationCustomAttributeRequest : Represents an [UpsertLocationCustomAttribute](api-endpoint:LocationCustomAttributes-UpsertLocationCustomAttribute) request.
...
impl UpsertLocationCustomAttributeRequest {
    /// Represents an [UpsertLocationCustomAttribute](api-endpoint:LocationCustomAttributes-UpsertLocationCustomAttribute) request.
    pub fn new(custom_attribute: models::CustomAttribute) -> UpsertLocationCustomAttributeRequest {
