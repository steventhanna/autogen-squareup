...
/// OrderCustomAttributeDefinitionVisibleDeletedEvent : Published when an order [custom attribute definition](entity:CustomAttributeDefinition) that is visible to the subscribing app is deleted.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct OrderCustomAttributeDefinitionVisibleDeletedEvent {
...
impl OrderCustomAttributeDefinitionVisibleDeletedEvent {
    ...
    pub fn new() -> OrderCustomAttributeDefinitionVisibleDeletedEvent {
