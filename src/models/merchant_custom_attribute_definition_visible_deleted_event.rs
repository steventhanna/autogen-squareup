...
/// MerchantCustomAttributeDefinitionVisibleDeletedEvent : Published when a merchant [custom attribute definition](entity:CustomAttributeDefinition) that is visible to the subscribing application is deleted. A notification is sent when your application deletes a custom attribute definition or another application deletes a custom attribute definition whose `visibility` is `VISIBILITY_READ_ONLY` or `VISIBILITY_READ_WRITE_VALUES`.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct MerchantCustomAttributeDefinitionVisibleDeletedEvent {
...
impl MerchantCustomAttributeDefinitionVisibleDeletedEvent {
    ...
    pub fn new() -> MerchantCustomAttributeDefinitionVisibleDeletedEvent {
