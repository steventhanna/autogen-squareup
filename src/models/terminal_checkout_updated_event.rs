...
/// TerminalCheckoutUpdatedEvent : Published when a [TerminalCheckout](entity:TerminalCheckout) is updated.
...
pub struct TerminalCheckoutUpdatedEvent {
    ...
    pub data: Option<Box<models::TerminalCheckoutUpdatedEventData>>,
}
