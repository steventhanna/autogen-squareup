...
/// PaymentUpdatedEvent : Published when a [Payment](entity:Payment) is updated. Typically the `payment.status`, or `card_details.status` fields are updated as a payment is canceled, authorized, or completed.
...
pub struct PaymentUpdatedEvent {
    ...
    pub data: Option<Box<models::PaymentUpdatedEventData>>,
}
...
impl PaymentUpdatedEvent {
    ...
    pub fn new() -> PaymentUpdatedEvent {
        PaymentUpdatedEvent {
            merchant_id: None,
            r#type: None,
            event_id: None,
