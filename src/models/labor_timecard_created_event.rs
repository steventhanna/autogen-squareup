...
/// LaborTimecardCreatedEvent : Published when a worker starts a [Timecard](entity:Timecard).
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct LaborTimecardCreatedEvent {
    ...
    pub data: Option<Box<models::LaborTimecardCreatedEventData>>,
}

impl LaborTimecardCreatedEvent {
    /// Published when a worker starts a [Timecard](entity:Timecard).
    pub fn new() -> LaborTimecardCreatedEvent {
