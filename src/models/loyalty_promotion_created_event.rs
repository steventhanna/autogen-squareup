...
/// LoyaltyPromotionCreatedEvent : Published when a [loyalty promotion](entity:LoyaltyPromotion) is created.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct LoyaltyPromotionCreatedEvent {
    ...
    pub data: Option<Box<models::LoyaltyPromotionCreatedEventData>>,
}

impl LoyaltyPromotionCreatedEvent {
    /// Published when a [loyalty promotion](entity:LoyaltyPromotion) is created.
    pub fn new() -> LoyaltyPromotionCreatedEvent {
