...
/// TerminalActionCreatedEvent : Published when a TerminalAction is created.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct TerminalActionCreatedEvent {
    ...
    pub data: Option<Box<models::TerminalActionCreatedEventData>>,
}

impl TerminalActionCreatedEvent {
    /// Published when a TerminalAction is created.
    pub fn new() -> TerminalActionCreatedEvent {
