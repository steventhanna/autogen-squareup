...
/// OrderCustomAttributeDefinitionVisibleCreatedEvent : Published when an order [custom attribute definition](entity:CustomAttributeDefinition) that is visible to the subscribing app is created.
