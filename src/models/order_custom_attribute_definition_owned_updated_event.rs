...
/// OrderCustomAttributeDefinitionOwnedUpdatedEvent : Published when an order [custom attribute definition](entity:CustomAttributeDefinition) that is owned by the subscribing app is updated.
