...
/// LaborScheduledShiftDeletedEvent : Published when a [ScheduledShift](entity:ScheduledShift) is deleted.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct LaborScheduledShiftDeletedEvent {
    ...
    pub data: Option<Box<models::LaborScheduledShiftDeletedEventData>>,
}

impl LaborScheduledShiftDeletedEvent {
    /// Published when a [ScheduledShift](entity:ScheduledShift) is deleted.
    pub fn new() -> LaborScheduledShiftDeletedEvent {
