...
impl std::fmt::Display for OrderFulfillmentFulfillmentLineItemApplication {
...
impl Default for OrderFulfillmentFulfillmentLineItemApplication {
    fn default() -> OrderFulfillmentFulfillmentLineItemApplication {
        Self::All
    }
}
