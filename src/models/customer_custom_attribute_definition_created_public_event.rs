...
impl CustomerCustomAttributeDefinitionCreatedPublicEvent {
    ...
    pub fn new() -> CustomerCustomAttributeDefinitionCreatedPublicEvent {
        CustomerCustomAttributeDefinitionCreatedPublicEvent {
            merchant_id: None,
            r#type: None,
            event_id: None,
