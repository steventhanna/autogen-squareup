...
/// BulkDeleteCustomersResponse : Defines the fields included in the response body from the [BulkDeleteCustomers](api-endpoint:Customers-BulkDeleteCustomers) endpoint.
...
pub struct BulkDeleteCustomersResponse {
    ...
    pub responses: Option<std::collections::HashMap<String, models::DeleteCustomerResponse>>,
    /// Any top-level errors that prevented the bulk operation from running.
    #[serde(rename = "errors", skip_serializing_if = "Option::is_none")]
    pub errors: Option<Vec<models::Error>>,
}

impl BulkDeleteCustomersResponse {
    ...
    pub fn new() -> BulkDeleteCustomersResponse {
