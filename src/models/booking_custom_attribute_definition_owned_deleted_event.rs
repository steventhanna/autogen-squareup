...
/// BookingCustomAttributeDefinitionOwnedDeletedEvent : Published when a booking [custom attribute definition](entity:CustomAttributeDefinition)  is deleted by the subscribing application. Subscribe to this event to be notified  when your application deletes a booking custom attribute definition.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct BookingCustomAttributeDefinitionOwnedDeletedEvent {
...
impl BookingCustomAttributeDefinitionOwnedDeletedEvent {
    ...
    pub fn new() -> BookingCustomAttributeDefinitionOwnedDeletedEvent {
