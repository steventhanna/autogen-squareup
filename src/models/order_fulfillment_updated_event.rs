...
/// OrderFulfillmentUpdatedEvent : Published when an [OrderFulfillment](entity:OrderFulfillment) is created or updated. This event is triggered only by the [UpdateOrder](api-endpoint:Orders-UpdateOrder) endpoint call.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct OrderFulfillmentUpdatedEvent {
    ...
    pub data: Option<Box<models::OrderFulfillmentUpdatedEventData>>,
}

impl OrderFulfillmentUpdatedEvent {
    ...
    pub fn new() -> OrderFulfillmentUpdatedEvent {
