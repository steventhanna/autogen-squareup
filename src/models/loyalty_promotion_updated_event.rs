...
/// LoyaltyPromotionUpdatedEvent : Published when a [loyalty promotion](entity:LoyaltyPromotion) is updated. This event is invoked only when a loyalty promotion is canceled.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct LoyaltyPromotionUpdatedEvent {
    ...
    pub data: Option<Box<models::LoyaltyPromotionUpdatedEventData>>,
}

impl LoyaltyPromotionUpdatedEvent {
    ...
    pub fn new() -> LoyaltyPromotionUpdatedEvent {
