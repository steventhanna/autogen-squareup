...
pub struct BatchUpsertCatalogObjectsRequest {
    ...
    pub batches: Vec<models::CatalogObjectBatch>,
}

impl BatchUpsertCatalogObjectsRequest {
    pub fn new(idempotency_key: String, batches: Vec<models::CatalogObjectBatch>) -> BatchUpsertCatalogObjectsRequest {
