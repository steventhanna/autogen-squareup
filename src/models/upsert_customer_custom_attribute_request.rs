...
/// UpsertCustomerCustomAttributeRequest : Represents an [UpsertCustomerCustomAttribute](api-endpoint:CustomerCustomAttributes-UpsertCustomerCustomAttribute) request.
...
impl UpsertCustomerCustomAttributeRequest {
    ...
    pub fn new(custom_attribute: models::CustomAttribute) -> UpsertCustomerCustomAttributeRequest {
