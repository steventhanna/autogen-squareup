...
/// LoyaltyProgramUpdatedEvent : Published when a [loyalty program](entity:LoyaltyProgram) is updated.
...
pub struct LoyaltyProgramUpdatedEvent {
    ...
    pub data: Option<Box<models::LoyaltyProgramUpdatedEventData>>,
}

impl LoyaltyProgramUpdatedEvent {
    /// Published when a [loyalty program](entity:LoyaltyProgram) is updated.
    pub fn new() -> LoyaltyProgramUpdatedEvent {
