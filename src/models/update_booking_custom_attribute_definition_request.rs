...
/// UpdateBookingCustomAttributeDefinitionRequest : Represents an [UpdateBookingCustomAttributeDefinition](api-endpoint:BookingCustomAttributes-UpdateBookingCustomAttributeDefinition) request.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct UpdateBookingCustomAttributeDefinitionRequest {
...
impl UpdateBookingCustomAttributeDefinitionRequest {
    ...
    pub fn new(custom_attribute_definition: models::CustomAttributeDefinition) -> UpdateBookingCustomAttributeDefinitionRequest {
