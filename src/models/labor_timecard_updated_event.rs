...
/// LaborTimecardUpdatedEvent : Published when a [Timecard](entity:Timecard) is updated.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct LaborTimecardUpdatedEvent {
    ...
    pub data: Option<Box<models::LaborTimecardUpdatedEventData>>,
}

impl LaborTimecardUpdatedEvent {
    /// Published when a [Timecard](entity:Timecard) is updated.
    pub fn new() -> LaborTimecardUpdatedEvent {
