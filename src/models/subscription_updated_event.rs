...
/// SubscriptionUpdatedEvent : Published when a [Subscription](entity:Subscription) is updated. Typically the `subscription.status` is updated as subscriptions become active or cancelled.
...
pub struct SubscriptionUpdatedEvent {
    ...
    pub data: Option<Box<models::SubscriptionUpdatedEventData>>,
}

impl SubscriptionUpdatedEvent {
    ...
    pub fn new() -> SubscriptionUpdatedEvent {
