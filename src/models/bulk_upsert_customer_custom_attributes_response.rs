...
/// BulkUpsertCustomerCustomAttributesResponse : Represents a [BulkUpsertCustomerCustomAttributes](api-endpoint:CustomerCustomAttributes-BulkUpsertCustomerCustomAttributes) response, which contains a map of responses that each corresponds to an individual upsert request.
...
pub struct BulkUpsertCustomerCustomAttributesResponse {
    ...
    pub values: Option<std::collections::HashMap<String, models::BulkUpsertCustomerCustomAttributesResponseCustomerCustomAttributeUpsertResponse>>,
    /// Any errors that occurred during the request.
    #[serde(rename = "errors", skip_serializing_if = "Option::is_none")]
    pub errors: Option<Vec<models::Error>>,
}

impl BulkUpsertCustomerCustomAttributesResponse {
    ...
    pub fn new() -> BulkUpsertCustomerCustomAttributesResponse {
