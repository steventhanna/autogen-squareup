...
/// CustomerCustomAttributeDefinitionVisibleUpdatedEvent : Published when a customer [custom attribute definition](entity:CustomAttributeDefinition) that is visible to the subscribing application is updated. A custom attribute definition can only be updated by the application that created it. A notification is sent when your application updates a custom attribute definition or when another application updates a custom attribute definition whose `visibility` is `VISIBILITY_READ_ONLY` or `VISIBILITY_READ_WRITE_VALUES`.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct CustomerCustomAttributeDefinitionVisibleUpdatedEvent {
...
impl CustomerCustomAttributeDefinitionVisibleUpdatedEvent {
    ...
    pub fn new() -> CustomerCustomAttributeDefinitionVisibleUpdatedEvent {
        CustomerCustomAttributeDefinitionVisibleUpdatedEvent {
            merchant_id: None,
            r#type: None,
            event_id: None,
