...
/// LoyaltyAccountUpdatedEvent : Published when a [loyalty account](entity:LoyaltyAccount) is updated.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct LoyaltyAccountUpdatedEvent {
    ...
    pub data: Option<Box<models::LoyaltyAccountUpdatedEventData>>,
}

impl LoyaltyAccountUpdatedEvent {
    /// Published when a [loyalty account](entity:LoyaltyAccount) is updated.
    pub fn new() -> LoyaltyAccountUpdatedEvent {
