...
/// LaborScheduledShiftPublishedEvent : Published when a [ScheduledShift](entity:ScheduledShift) is published.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct LaborScheduledShiftPublishedEvent {
    ...
    pub data: Option<Box<models::LaborScheduledShiftPublishedEventData>>,
}

impl LaborScheduledShiftPublishedEvent {
    /// Published when a [ScheduledShift](entity:ScheduledShift) is published.
    pub fn new() -> LaborScheduledShiftPublishedEvent {
