...
/// LoyaltyEventCreatedEvent : Published when a [loyalty event](entity:LoyaltyEvent) is created.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct LoyaltyEventCreatedEvent {
    ...
    pub data: Option<Box<models::LoyaltyEventCreatedEventData>>,
}

impl LoyaltyEventCreatedEvent {
    /// Published when a [loyalty event](entity:LoyaltyEvent) is created.
    pub fn new() -> LoyaltyEventCreatedEvent {
