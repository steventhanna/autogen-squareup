...
/// TransferOrderUpdatedEvent : Published when a transfer_order is updated.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct TransferOrderUpdatedEvent {
    ...
    pub data: Option<Box<models::TransferOrderUpdatedEventData>>,
}

impl TransferOrderUpdatedEvent {
    /// Published when a transfer_order is updated.
    pub fn new() -> TransferOrderUpdatedEvent {
