...
/// InvoiceScheduledChargeFailedEvent : Published when an automatic scheduled payment for an [Invoice](entity:Invoice) has failed.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct InvoiceScheduledChargeFailedEvent {
    ...
    pub data: Option<Box<models::InvoiceScheduledChargeFailedEventData>>,
}

impl InvoiceScheduledChargeFailedEvent {
    /// Published when an automatic scheduled payment for an [Invoice](entity:Invoice) has failed.
    pub fn new() -> InvoiceScheduledChargeFailedEvent {
