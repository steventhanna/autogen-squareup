...
/// LaborTimecardDeletedEvent : Published when a [Timecard](entity:Timecard) is deleted.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct LaborTimecardDeletedEvent {
    ...
    pub data: Option<Box<models::LaborTimecardDeletedEventData>>,
}

impl LaborTimecardDeletedEvent {
    /// Published when a [Timecard](entity:Timecard) is deleted.
    pub fn new() -> LaborTimecardDeletedEvent {
