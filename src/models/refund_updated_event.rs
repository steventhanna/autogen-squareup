...
/// RefundUpdatedEvent : Published when a [Refund](entity:PaymentRefund) is updated. Typically the `refund.status` changes when a refund is completed.
...
pub struct RefundUpdatedEvent {
    ...
    pub data: Option<Box<models::RefundUpdatedEventData>>,
}
