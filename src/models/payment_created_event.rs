...
/// PaymentCreatedEvent : Published when a [Payment](entity:Payment) is created.
...
pub struct PaymentCreatedEvent {
    ...
    pub data: Option<Box<models::PaymentCreatedEventData>>,
}

impl PaymentCreatedEvent {
    /// Published when a [Payment](entity:Payment) is created.
    pub fn new() -> PaymentCreatedEvent {
        PaymentCreatedEvent {
            merchant_id: None,
            r#type: None,
            event_id: None,
