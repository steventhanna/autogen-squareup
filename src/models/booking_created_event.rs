...
/// BookingCreatedEvent : Published when a booking is created.  To receive this event with buyer-level permissions, you must have `APPOINTMENTS_READ` set for the OAuth scope.   To receive this event with seller-level permissions, you must have `APPOINTMENTS_ALL_READ` and `APPOINTMENTS_READ` set for the OAuth scope.
...
pub struct BookingCreatedEvent {
    ...
    pub data: Option<Box<models::BookingCreatedEventData>>,
}
...
impl BookingCreatedEvent {
    ...
    pub fn new() -> BookingCreatedEvent {
        BookingCreatedEvent {
            merchant_id: None,
            r#type: None,
            event_id: None,
