...
/// LaborScheduledShiftCreatedEvent : Published when a [ScheduledShift](entity:ScheduledShift) is created.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct LaborScheduledShiftCreatedEvent {
    ...
    pub data: Option<Box<models::LaborScheduledShiftCreatedEventData>>,
}

impl LaborScheduledShiftCreatedEvent {
    /// Published when a [ScheduledShift](entity:ScheduledShift) is created.
    pub fn new() -> LaborScheduledShiftCreatedEvent {
