...
/// ListBookingCustomAttributeDefinitionsResponse : Represents a [ListBookingCustomAttributeDefinitions](api-endpoint:BookingCustomAttributes-ListBookingCustomAttributeDefinitions) response. Either `custom_attribute_definitions`, an empty object, or `errors` is present in the response. If additional results are available, the `cursor` field is also present along with `custom_attribute_definitions`.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct ListBookingCustomAttributeDefinitionsResponse {
...
impl ListBookingCustomAttributeDefinitionsResponse {
    ...
    pub fn new() -> ListBookingCustomAttributeDefinitionsResponse {
