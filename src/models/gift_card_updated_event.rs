...
/// GiftCardUpdatedEvent : Published when a [gift card](entity:GiftCard) is updated. This includes changes to the state, balance, and customer association.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct GiftCardUpdatedEvent {
    ...
    pub data: Option<Box<models::GiftCardUpdatedEventData>>,
}

impl GiftCardUpdatedEvent {
    /// Published when a [gift card](entity:GiftCard) is updated. This includes changes to the state, balance, and customer association.
    pub fn new() -> GiftCardUpdatedEvent {
