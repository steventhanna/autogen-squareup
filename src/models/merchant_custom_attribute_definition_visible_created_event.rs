...
pub struct MerchantCustomAttributeDefinitionVisibleCreatedEvent {
...
impl MerchantCustomAttributeDefinitionVisibleCreatedEvent {
    /// Published when a merchant [custom attribute definition](entity:CustomAttributeDefinition) that is visible to the subscribing application is created. A notification is sent when your application creates a custom attribute definition or another application creates a custom attribute definition whose `visibility` is `VISIBILITY_READ_ONLY` or `VISIBILITY_READ_WRITE_VALUES`.
    pub fn new() -> MerchantCustomAttributeDefinitionVisibleCreatedEvent {
        MerchantCustomAttributeDefinitionVisibleCreatedEvent {
            merchant_id: None,
            r#type: None,
            event_id: None,
