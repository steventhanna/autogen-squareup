...
/// InvoicePublishedEvent : Published when an [Invoice](entity:Invoice) transitions from a draft to a non-draft status.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct InvoicePublishedEvent {
    ...
    pub data: Option<Box<models::InvoicePublishedEventData>>,
}

impl InvoicePublishedEvent {
    /// Published when an [Invoice](entity:Invoice) transitions from a draft to a non-draft status.
    pub fn new() -> InvoicePublishedEvent {
