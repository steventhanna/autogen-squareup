...
/// CustomerCustomAttributeOwnedDeletedEvent : Published when a customer [custom attribute](entity:CustomAttribute) owned by the subscribing application is deleted. Custom attributes are owned by the application that created the corresponding [custom attribute definition](entity:CustomAttributeDefinition). Custom attributes whose `visibility` is `VISIBILITY_READ_WRITE_VALUES` can be deleted by any application.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct CustomerCustomAttributeOwnedDeletedEvent {
...
impl CustomerCustomAttributeOwnedDeletedEvent {
    ...
    pub fn new() -> CustomerCustomAttributeOwnedDeletedEvent {
        CustomerCustomAttributeOwnedDeletedEvent {
            merchant_id: None,
            r#type: None,
            event_id: None,
