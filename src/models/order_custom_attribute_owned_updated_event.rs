...
/// OrderCustomAttributeOwnedUpdatedEvent : Published when an order [custom attribute](entity:CustomAttribute) associated with a [custom attribute definition](entity:CustomAttributeDefinition) that is owned by the subscribing app is updated.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct OrderCustomAttributeOwnedUpdatedEvent {
...
impl OrderCustomAttributeOwnedUpdatedEvent {
    ...
    pub fn new() -> OrderCustomAttributeOwnedUpdatedEvent {
