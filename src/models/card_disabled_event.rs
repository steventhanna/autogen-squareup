...
/// CardDisabledEvent : Published when a [card](entity:Card) is disabled.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct CardDisabledEvent {
    ...
    pub data: Option<Box<models::CardDisabledEventData>>,
}

impl CardDisabledEvent {
    /// Published when a [card](entity:Card) is disabled.
    pub fn new() -> CardDisabledEvent {
        CardDisabledEvent {
            merchant_id: None,
            r#type: None,
            event_id: None,
