...
/// GiftCardCreatedEvent : Published when a [gift card](entity:GiftCard) is created.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct GiftCardCreatedEvent {
    ...
    pub data: Option<Box<models::GiftCardCreatedEventData>>,
}

impl GiftCardCreatedEvent {
    /// Published when a [gift card](entity:GiftCard) is created.
    pub fn new() -> GiftCardCreatedEvent {
