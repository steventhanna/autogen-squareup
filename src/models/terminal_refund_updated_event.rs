...
/// TerminalRefundUpdatedEvent : Published when a Terminal API refund is updated.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct TerminalRefundUpdatedEvent {
    ...
    pub data: Option<Box<models::TerminalRefundUpdatedEventData>>,
}

impl TerminalRefundUpdatedEvent {
    /// Published when a Terminal API refund is updated.
    pub fn new() -> TerminalRefundUpdatedEvent {
