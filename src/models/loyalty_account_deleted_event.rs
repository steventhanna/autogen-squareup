...
/// LoyaltyAccountDeletedEvent : Published when a [loyalty account](entity:LoyaltyAccount) is deleted.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct LoyaltyAccountDeletedEvent {
    ...
    pub data: Option<Box<models::LoyaltyAccountDeletedEventData>>,
}

impl LoyaltyAccountDeletedEvent {
    /// Published when a [loyalty account](entity:LoyaltyAccount) is deleted.
    pub fn new() -> LoyaltyAccountDeletedEvent {
