...
/// OrderCustomAttributeOwnedDeletedEvent : Published when an order [custom attribute](entity:CustomAttribute) associated with a [custom attribute definition](entity:CustomAttributeDefinition) that is owned by the subscribing app is deleted.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct OrderCustomAttributeOwnedDeletedEvent {
...
impl OrderCustomAttributeOwnedDeletedEvent {
    ...
    pub fn new() -> OrderCustomAttributeOwnedDeletedEvent {
