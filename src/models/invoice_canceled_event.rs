...
/// InvoiceCanceledEvent : Published when an [Invoice](entity:Invoice) is canceled.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct InvoiceCanceledEvent {
    ...
    pub data: Option<Box<models::InvoiceCanceledEventData>>,
}

impl InvoiceCanceledEvent {
    /// Published when an [Invoice](entity:Invoice) is canceled.
    pub fn new() -> InvoiceCanceledEvent {
