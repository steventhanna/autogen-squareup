...
/// LocationSettingsUpdatedEvent : Published when online checkout location settings are updated
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct LocationSettingsUpdatedEvent {
    ...
    pub data: Option<Box<models::LocationSettingsUpdatedEventData>>,
}

impl LocationSettingsUpdatedEvent {
    /// Published when online checkout location settings are updated
    pub fn new() -> LocationSettingsUpdatedEvent {
