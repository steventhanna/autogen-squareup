...
/// LoyaltyPromotionAvailableTimeData : Represents scheduling information that determines when purchases can qualify to earn points from a [loyalty promotion](entity:LoyaltyPromotion).
...
pub struct LoyaltyPromotionAvailableTimeData {
    ...
    #[serde(rename = "time_periods")]
    pub time_periods: Vec<String>,
}

impl LoyaltyPromotionAvailableTimeData {
    ...
    pub fn new(time_periods: Vec<String>) -> LoyaltyPromotionAvailableTimeData {
