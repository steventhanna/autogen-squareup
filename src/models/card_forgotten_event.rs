...
/// CardForgottenEvent : Published when a [card](entity:Card) is GDPR forgotten or vaulted.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct CardForgottenEvent {
    ...
    pub data: Option<Box<models::CardForgottenEventData>>,
}

impl CardForgottenEvent {
    /// Published when a [card](entity:Card) is GDPR forgotten or vaulted.
    pub fn new() -> CardForgottenEvent {
        CardForgottenEvent {
            merchant_id: None,
            r#type: None,
            event_id: None,
